package xp.timepicker.com.androidtimepicker;
...
import xp.timepicker.com.widget.DatePickDialog;
import xp.timepicker.com.widget.OnSureLisener;
    ...
    private void showDatePickDialog(DateType type) {
        ...
        dialog.setOnSureLisener(new OnSureLisener() {
            ...
            public void onSure(Date date) {
                if (!TextUtils.isEmpty("yyyy-MM-dd HH:mm")) {
                    String messge = "";
                    try {
                        messge = new SimpleDateFormat("yyyy-MM-dd HH:mm").format(date);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    Log.e("onSure", messge);
